    ...
    <div class="card shadow-sm border-0 rounded-4 mb-3">
        ...
        <div class="card-body">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-3">
                        <select name="filter" class="form-select">
                            ...
                            <option value="Hadir"
                                {{ request('filter') == 'Hadir' ? 'selected' : '' }}>
                                Hadir
                            </option>

                            <option value="Sakit"
                                {{ request('filter') == 'Sakit' ? 'selected' : '' }}>
                                Sakit
                            </option>

                            <option value="Izin"
                                {{ request('filter') == 'Izin' ? 'selected' : '' }}>
                                Izin
                            </option>

                            <option value="Dinas Luar"
                                {{ request('filter') == 'Dinas Luar' ? 'selected' : '' }}>
                                Dinas Luar
                            </option>
                        </select>
                    </div>
                        ...
                        @forelse($attendances as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($item->keterangan_kehadiran == 'Dinas Luar')
            ...
            @if($attendances->count() > 0)
                ...
                <div class="mt-4">
                    <h6 class="fw-bold mb-3" style="color:#425A73;">
                        Rekap Kehadiran Pegawai
                    </h6>

                    <div class="d-flex gap-3">

                        <div class="flex-fill text-center py-3 rounded-3 shadow-sm"
