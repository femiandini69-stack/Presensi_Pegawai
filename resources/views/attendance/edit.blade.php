        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-header bg-white py-3">
                <h5 class="m-0 text-warning fw-bold">
                    ✏️ Edit Catatan Presensi Pegawai
                </h5>
            </div>
                ...
                <form action="{{ route('attendance.update', $attendance->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="keterangan_kehadiran">
                            ...
                            <option value="Hadir"
                                {{ $attendance->keterangan_kehadiran == 'Hadir' ? 'selected' : '' }}>
                                Hadir
                            </option>

                            <option value="Sakit"
                                {{ $attendance->keterangan_kehadiran == 'Sakit' ? 'selected' : '' }}>
                                Sakit
                            </option>

                            <option value="Izin"
                                {{ $attendance->keterangan_kehadiran == 'Izin' ? 'selected' : '' }}>
                                Izin
                            </option>

                            <option value="Dinas Luar"
                                {{ $attendance->keterangan_kehadiran == 'Dinas Luar' ? 'selected' : '' }}>
                                Dinas Luar
                            </option>
